...
{
    (string token, int expiresIn, int refreshTokenExpiryDays) GenerateToken(UserTokenRequestDto tokenRequest, IEnumerable<string> roles, IEnumerable<string> permissions, string? securityStamp = null);
