...
public class CreatePollCommandHandler(
    ...
    : IRequestHandler<CreatePollCommand, Result<PollResponseDto>>
{
    public async Task<Result<PollResponseDto>> Handle(CreatePollCommand request, CancellationToken cancellationToken)
    {
        ...
        if (exists)
        {
            ...
            return Result.Failure<PollResponseDto>(error);
        }
